            ...
            <div class="row g-0">
                <div class="col-12 d-flex flex-column">
                    <div class="card-body">
                        ...
                        <div class="row g-2">
                            <div class="col-md-4">
                                <x-input type="text" class="form-control maska" data-maska="['###.###.###-##', '##.###.###/####-##']" value="{{ $user->paciente->cpf }}"
                        ...
                        <div class="row g-2 mt-2" style="align-items: flex-end;">
                            ...
                            <div class="col-md-4">
                                <x-input type="tel" class="form-control" data-maska="(##) #####-####" value="{{ $user->paciente->telefone }}"
                ...
                <div class="col-12 d-flex flex-column">
                    <div class="card-body">
                        ...
                        <div class="row g-2 mt-2" style="align-items: flex-end;">
                            ...
                            <div class="col-md-4">
                                <x-input type="tel" class="form-control" value="" data-maska="(##) #####-####" readonly>Telefone</x-input>
                                <!-- <x-button class="btn">Alterar</x-button>-->
                            </div>
                        </div>
            ...
            <div class="row g-0">
                <div class="col-12 d-flex flex-column">
                    <div class="card-body">
                        ...
                        <div class="row g-2">
                            <div class="col-md-4">
                                <x-input type="text" class="form-control" data-maska="###.###.###-##" value="" readonly>CPF</x-input>
                            </div>
                            <div class="col-md-4">
                                <x-input type="date" class="form-control" value="" readonly>Data de
                                    Nascimento</x-input>
                        ...
                        <div class="row g-2 mt-2" style="align-items: flex-end;">
                            ...
                            <div class="col-md-4">
                                <x-input type="tel" class="form-control" data-maska="(##) #####-####" value="{{ $user->administrador->telefone }}"
                                    readonly>Telefone</x-input>
                                <!-- <x-button class="btn">Alterar</x-button>-->
                            </div>
                        </div>
